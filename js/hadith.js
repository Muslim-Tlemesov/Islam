...
(function () {
  ...
  function explanationHtml(text, mode) {
    const sourceHtml = mode === "short" && hadith.explanation.source
      ...
      ${
        hasExplanation
          ? `<div class="hadith__explanation-toggle" id="explanation-toggle">
             ...
             <div class="hadith__explanation-text" id="explanation-text">${explanationHtml(hadith.explanation.short || hadith.explanation.detailed, hadith.explanation.short ? "short" : "detailed")}</div>`
  ...
  if (toggle) {
    toggle.addEventListener("click", (e) => {
      ...
      document.getElementById("explanation-text").innerHTML = explanationHtml(text, mode);
    });
  }
})();
